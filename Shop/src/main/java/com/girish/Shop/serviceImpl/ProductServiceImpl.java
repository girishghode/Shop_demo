...
import com.girish.Shop.enums.ProductStatusEnum;
...
public class ProductServiceImpl implements ProductService
{
    ...
    public Page<ProductInfo> findUpAll(Pageable pageable) {
        return productInfoRepository.findAllByProductStatusOrderByProductIdAsc(ProductStatusEnum
        		.UP.getCode(),pageable);
    }
    ...
    public void increaseStock(String productId, int amount) {
        ...
        if (productInfo == null) throw new MyException(ResultEnum
        		.PRODUCT_NOT_EXIST);
