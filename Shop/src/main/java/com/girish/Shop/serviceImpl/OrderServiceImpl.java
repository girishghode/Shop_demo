...
import com.girish.Shop.entity.OrderMain;
import com.girish.Shop.entity.ProductInOrder;
import com.girish.Shop.entity.ProductInfo;
import com.girish.Shop.enums.OrderStatusEnum;
import com.girish.Shop.enums.ResultEnum;
import com.girish.Shop.exception.MyException;
import com.girish.Shop.repository.OrderRepository;
import com.girish.Shop.repository.ProductInOrderRepository;
import com.girish.Shop.repository.ProductInfoRepository;
import com.girish.Shop.repository.UserRepository;
import com.girish.Shop.service.OrderService;
import com.girish.Shop.service.ProductService;
...
public class OrderServiceImpl implements OrderService
{
    ...
    public OrderMain finish(Long orderId) {
        ...
        if(!orderMain.getOrderStatus().equals(OrderStatusEnum
        		.NEW.getCode())) {
